...
#endif
    buttergotchiConfigPins.gps_bus.rx = (gpio_num_t)GPS_SERIAL_RX;
    buttergotchiConfigPins.gps_bus.tx = (gpio_num_t)GPS_SERIAL_TX;
    buttergotchiConfigPins.gpsBaudrate = 9600;
    buttergotchiConfigPins.rfTx = 8;
    buttergotchiConfigPins.rfRx = 9;
}
...
void InputHandler(void) {
    ...
    if (_IH_touched) {
        ...
        Serial.printf("\nROT: Touch Pressed on x=%d, y=%d, rot=%d\n", t.x, t.y, buttergotchiConfigPins.rotation);
