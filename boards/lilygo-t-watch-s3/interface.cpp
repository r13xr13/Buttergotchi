...
void _setup_gpio() {
    ...
    buttergotchiConfig.disabledMenus.push_back("RF");
    buttergotchiConfig.disabledMenus.push_back("NRF24");
    ...
    buttergotchiConfigPins.gpsBaudrate = 38400;
}
...
void InputHandler(void) {
    ...
    if (millis() - tm > 200 || LongPress) {
        ...
        if (getTouched()) {
            ...
            if (buttergotchiConfigPins.rotation == 1) { t.x[0] = tftWidth - t.x[0]; }
