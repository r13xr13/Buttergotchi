...
#define BUTTERGOTCHI_TFT_DRIVER tft_display
#else
#include <VectorDisplay.h>
#define BUTTERGOTCHI_TFT_DRIVER SerialDisplayClass
#endif
...
class tft_logger : public BUTTERGOTCHI_TFT_DRIVER {
private:
    tftLog *log = nullptr;
...
public:
    ...
    // Expose base class methods not overridden by tft_logger
    using BUTTERGOTCHI_TFT_DRIVER::drawPixel;
    using BUTTERGOTCHI_TFT_DRIVER::pushImage;
    using BUTTERGOTCHI_TFT_DRIVER::width;
    using BUTTERGOTCHI_TFT_DRIVER::height;
    using BUTTERGOTCHI_TFT_DRIVER::getTextColor;
    using BUTTERGOTCHI_TFT_DRIVER::getTextSize;
    using BUTTERGOTCHI_TFT_DRIVER::getTextBgColor;
