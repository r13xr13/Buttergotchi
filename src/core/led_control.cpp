...
void ledEffectTask(void *pvParameters) {
    ...
    while (1) {
        CRGB baseColor = isPreviewLed ? previewLedColor : buttergotchiConfig.ledColor;
        int ledEffect = isPreviewLed ? previewLedEffect : buttergotchiConfig.ledEffect;
        int ledEffectSpeed = isPreviewLed ? previewLedEffectSpeed : buttergotchiConfig.ledEffectSpeed;
        int ledEffectDirection = isPreviewLed ? previewLedEffectDirection : buttergotchiConfig.ledEffectDirection;
...
void beginLed() {
    ...
    */
    ...
    setLedBrightness(buttergotchiConfig.ledBright);
}

void blinkLed(int blinkTime) {
    if (!buttergotchiConfig.ledBlinkEnabled) return;

    int ledBrightFrom = buttergotchiConfig.ledBright;
...
#define ButtergotchiPurple 9830500 // Custom purple color for Buttergotchi
...
void setLedColorConfig() {
    ...
    while (1) {
        ...
        for (const auto &mapping : colorMappings) {
            if (buttergotchiConfig.ledColor == mapping.color) { idx = i; }
            colorStorage[i] = mapping.color;

            options.emplace_back(
                mapping.name,
                [=, &mapping]() {
                    // buttergotchiConfig.setLedColor(mapping.color);
                    buttergotchiConfig.setLedColor(
        ...
        options.push_back(
            {"Custom Color",
             ...
             [](void *pointer, bool shouldRender) {
                 setLedColor(buttergotchiConfig.ledColor);
                 return false;
             }}
        );
...
void setCustomColorSettingMenu(int rgb, std::function<uint32_t(uint32_t, int)> colorGenerator) {
    uint32_t originalColor = buttergotchiConfig.ledColor;
    ...
    while (i <= 255) {
        if (i % LED_COLOR_STEP == 0 || i == 255) {
            ...
            options.emplace_back(
                String(i),
                [updatedColor]() { buttergotchiConfig.setLedColor(updatedColor); },
                selectedIndex == index,
                hoverFunction,
                &colorStorage[index]
            );
...
void setLedEffectConfig() {
    ...
    while (1) {
        options = {
            {"Solid Color",
             [=]() { buttergotchiConfig.setLedEffect(LED_EFFECT_SOLID); },
             buttergotchiConfig.ledEffect == LED_EFFECT_SOLID,
             [](void *pointer,                                                                         bool shouldRender) {
            ...
            {"Breathe",
             [=]() { buttergotchiConfig.setLedEffect(LED_COLOR_BREATHE); },
             buttergotchiConfig.ledEffect == LED_COLOR_BREATHE,
             [](void *pointer,                                                                         bool shouldRender) {
                 setLedEffect(LED_COLOR_BREATHE);
                 return false;
             }                                                                        },
            {"Color Cycle",
             [=]() { buttergotchiConfig.setLedEffect(LED_EFFECT_COLOR_CYCLE); },
             buttergotchiConfig.ledEffect == LED_EFFECT_COLOR_CYCLE,
             [](void *pointer,                                                                         bool shouldRender) {
...
#if LED_COUNT > 1
            {"Color Wheel",
             [=]() { buttergotchiConfig.setLedEffect(LED_EFFECT_COLOR_WHEEL); },
             buttergotchiConfig.ledEffect == LED_EFFECT_COLOR_WHEEL,
             [](void *pointer,                                                                         bool shouldRender) {
                 setLedEffect(LED_EFFECT_COLOR_WHEEL);
                 return false;
             }                                                                        },
            {"Chase",
             [=]() { buttergotchiConfig.setLedEffect(LED_EFFECT_CHASE); },
             buttergotchiConfig.ledEffect == LED_EFFECT_CHASE,
             [](void *pointer,                                                                         bool shouldRender) {
                 setLedEffect(LED_EFFECT_CHASE);
                 return false;
             }                                                                        },
            {"Chase Tail",
             [=]() { buttergotchiConfig.setLedEffect(LED_EFFECT_CHASE_TAIL); },
             buttergotchiConfig.ledEffect == LED_EFFECT_CHASE_TAIL,
             [](void *pointer,                                                                         bool shouldRender) {
                 setLedEffect(LED_EFFECT_CHASE_TAIL);
                 return false;
             }                                                                        },
            {"Rainbow Chase",
             [=]() { buttergotchiConfig.setLedEffect(LED_EFFECT_RAINBOW_CHASE); },
             buttergotchiConfig.ledEffect == LED_EFFECT_RAINBOW_CHASE,
             [](void *pointer,                                                                         bool shouldRender) {
                 setLedEffect(LED_EFFECT_RAINBOW_CHASE);
                 return false;
             }                                                                        },
            {"Rainbow Breathe",
             [=]() { buttergotchiConfig.setLedEffect(LED_EFFECT_RAINBOW_BREATHE); },
             buttergotchiConfig.ledEffect == LED_EFFECT_RAINBOW_BREATHE,
             [](void *pointer,                                                                         bool shouldRender) {
                 setLedEffect(LED_EFFECT_RAINBOW_BREATHE);
                 return false;
             }                                                                        },
            {"Disco",
             [=]() { buttergotchiConfig.setLedEffect(LED_EFFECT_DISCO); },
             buttergotchiConfig.ledEffect == LED_EFFECT_DISCO,
             [](void *pointer,                                                                         bool shouldRender) {
                 setLedEffect(LED_EFFECT_DISCO);
                 return false;
             }                                                                        },
            {"Fire",
             [=]() { buttergotchiConfig.setLedEffect(LED_EFFECT_FIRE); },
             buttergotchiConfig.ledEffect == LED_EFFECT_FIRE,
             [](void *pointer,                                                                         bool shouldRender) {
            ...
            {"Config - Speed",
             ...
             [](void *pointer,                                                                         bool shouldRender) {
                 previewLedEffect = buttergotchiConfig.ledEffect;
                 previewLedEffectSpeed = buttergotchiConfig.ledEffectSpeed;
                 previewLedEffectDirection = buttergotchiConfig.ledEffectDirection;
                 return false;
             }                                                                        },
        ...
        int selectedOption = loopOptions(options, buttergotchiConfig.ledEffect);
        if (selectedOption == -1 || selectedOption == options.size() - 1) {
            ledPreviewMode(false);
            ledSetup();
            return;
...
void setLedEffectSpeedConfig() {
    ...
    while (i < 10) {
        ...
        bool isSelected = (buttergotchiConfig.ledEffectSpeed == i + 1);

        options.emplace_back(
            label,
            [i]() { buttergotchiConfig.setLedEffectSpeed(i + 1); },
            (buttergotchiConfig.ledEffectSpeed == i + 1),
            hoverFunction,
            &speedStorage[i]
        );
        ++i;
    ...
    options.emplace_back(
        "Sync To Encoder",
        []() { buttergotchiConfig.setLedEffectSpeed(11); },
        (buttergotchiConfig.ledEffectSpeed == 11),
        hoverFunction,
        &speedStorage[10]
    );
#endif
    ...
    int selectedOption = loopOptions(options, buttergotchiConfig.ledEffectSpeed - 1);
    if (selectedOption == -1 || selectedOption == options.size() - 1) {
        previewLedEffectSpeed = buttergotchiConfig.ledEffectSpeed;
        return;
    }
...
void setLedEffectDirectionConfig() {
    options = {
        {"Clockwise",
         [=]() { buttergotchiConfig.setLedEffectDirection(1); },
    ...
    int selectedOption = loopOptions(options, (buttergotchiConfig.ledEffectDirection == 1) ? 0 : 1);
    if (selectedOption == -1 || selectedOption == options.size() - 1) {
        previewLedEffectDirection = buttergotchiConfig.ledEffectDirection;
        return;
    }
...
void ledSetup() {
    if (buttergotchiConfig.ledEffect == LED_EFFECT_SOLID) { ledEffects(false); }

    if (buttergotchiConfig.ledEffect > LED_EFFECT_SOLID) {
        ledEffects(true);
    } else setLedColor(buttergotchiConfig.ledColor);
}
...
void ledPreviewMode(bool enable) {
    isPreviewLed = enable;
    if (enable) {
        previewLedColor = buttergotchiConfig.ledColor;
        previewLedEffect = buttergotchiConfig.ledEffect;
        previewLedEffectSpeed = buttergotchiConfig.ledEffectSpeed;
        previewLedEffectDirection = buttergotchiConfig.ledEffectDirection;
    }
...
void setLedBrightnessConfig() {
    int idx = 0;
    if (buttergotchiConfig.ledBright == 0) idx = 0;
    else if (buttergotchiConfig.ledBright == 10) idx = 1;
    else if (buttergotchiConfig.ledBright == 25) idx = 2;
    else if (buttergotchiConfig.ledBright == 50) idx = 3;
    else if (buttergotchiConfig.ledBright == 75) idx = 4;
    else if (buttergotchiConfig.ledBright == 100) idx = 5;

    options = {
        {"OFF",
         [=]() { buttergotchiConfig.setLedBright(0); },
         buttergotchiConfig.ledBright == 0,
         [](void *pointer, bool shouldRender) {
             setLedBrightness(0);
             return false;
         }},
        {"10 %",
         [=]() { buttergotchiConfig.setLedBright(10); },
         buttergotchiConfig.ledBright == 10,
         [](void *pointer, bool shouldRender) {
             setLedBrightness(10);
             return false;
         }},
        {"25 %",
         [=]() { buttergotchiConfig.setLedBright(25); },
         buttergotchiConfig.ledBright == 25,
         [](void *pointer, bool shouldRender) {
             setLedBrightness(25);
             return false;
         }},
        {"50 %",
         [=]() { buttergotchiConfig.setLedBright(50); },
        ...
        {"75 %",
         [=]() { buttergotchiConfig.setLedBright(75); },
         buttergotchiConfig.ledBright == 75,
         [](void *pointer, bool shouldRender) {
             setLedBrightness(75);
             return false;
         }},
        {"100%",
         [=]() { buttergotchiConfig.setLedBright(100); },
         buttergotchiConfig.ledBright == 100,
         [](void *pointer, bool shouldRender) {
