...
void ButtergotchiConfigPins::fromJson(JsonObject obj) {
    int count = 0;
...
void ButtergotchiConfigPins::toJson(JsonObject obj) const {
...
void ButtergotchiConfigPins::loadFile(JsonDocument &jsonDoc, bool checkFS) {
    FS *fs;
    if (checkFS) {
...
void ButtergotchiConfigPins::fromFile(bool checkFS) {
...
void ButtergotchiConfigPins::createFile() {
    JsonDocument jsonDoc;
...
void ButtergotchiConfigPins::saveFile() {
    JsonDocument jsonDoc;
    loadFile(jsonDoc);
...
void ButtergotchiConfigPins::factoryReset() {
    FS *fs = &LittleFS;
...
void ButtergotchiConfigPins::validateConfig() {
...
#if !defined(LITE_VERSION)
void ButtergotchiConfigPins::setLoRaPins(SPIPins value) {
    LoRa_bus = value;
    validateSpiPins(LoRa_bus);
    saveFile();
}
void ButtergotchiConfigPins::setW5500Pins(SPIPins value) {
    LoRa_bus = value;
    validateSpiPins(W5500_bus);
    saveFile();
}
#endif
void ButtergotchiConfigPins::setCC1101Pins(SPIPins value) {
    CC1101_bus = value;
    validateSpiPins(CC1101_bus);
    saveFile();
}

void ButtergotchiConfigPins::setNrf24Pins(SPIPins value) {
    NRF24_bus = value;
    validateSpiPins(NRF24_bus);
    saveFile();
}

void ButtergotchiConfigPins::setPn532Pins(SPIPins value) {
    PN532_bus = value;
    validateSpiPins(PN532_bus);
    saveFile();
}

void ButtergotchiConfigPins::setSDCardPins(SPIPins value) {
    SDCARD_bus = value;
    validateSpiPins(SDCARD_bus);
    saveFile();
}

void ButtergotchiConfigPins::setSpiPins(SPIPins value) {
    validateSpiPins(value);
    saveFile();
}

void ButtergotchiConfigPins::setI2CPins(I2CPins value) {
    validateI2CPins(value);
    saveFile();
}

void ButtergotchiConfigPins::setUARTPins(UARTPins value) {
    validateUARTPins(value);
    saveFile();
}
void ButtergotchiConfigPins::validateSpiPins(SPIPins value) {
...
void ButtergotchiConfigPins::validateI2CPins(I2CPins value) {
...
void ButtergotchiConfigPins::validateUARTPins(UARTPins value) {
    if (value.rx < 0 || value.rx > GPIO_PIN_COUNT) value.rx = GPIO_NUM_NC;
    if (value.tx < 0 || value.tx > GPIO_PIN_COUNT) value.tx = GPIO_NUM_NC;
}

void ButtergotchiConfigPins::setRotation(int value) {
    rotation = value;
    validateRotationValue();
    saveFile();
}

void ButtergotchiConfigPins::validateRotationValue() {
    if (rotation < 0 || rotation > 3) rotation = 1;
}

void ButtergotchiConfigPins::setBleName(String value) {
    bleName = value;
    saveFile();
}

void ButtergotchiConfigPins::setIrTxPin(int value) {
    irTx = value;
    saveFile();
}

void ButtergotchiConfigPins::setIrTxRepeats(uint8_t value) {
    irTxRepeats = value;
    saveFile();
}

void ButtergotchiConfigPins::setIrRxPin(int value) {
    irRx = value;
    saveFile();
}

void ButtergotchiConfigPins::setRfTxPin(int value) {
    rfTx = value;
    saveFile();
}

void ButtergotchiConfigPins::setRfRxPin(int value) {
    rfRx = value;
    saveFile();
}

void ButtergotchiConfigPins::setRfModule(RFModules value) {
    rfModule = value;
    validateRfModuleValue();
    saveFile();
}

void ButtergotchiConfigPins::validateRfModuleValue() {
    if (rfModule != M5_RF_MODULE && rfModule != CC1101_SPI_MODULE) { rfModule = M5_RF_MODULE; }
}

void ButtergotchiConfigPins::setRfFreq(float value, int fxdFreq) {
    rfFreq = value;
    if (fxdFreq > 1) rfFxdFreq = fxdFreq;
    saveFile();
}

void ButtergotchiConfigPins::setRfFxdFreq(float value) {
    rfFxdFreq = value;
    saveFile();
}

void ButtergotchiConfigPins::setRfScanRange(int value, int fxdFreq) {
    rfScanRange = value;
    rfFxdFreq = fxdFreq;
    validateRfScanRangeValue();
    saveFile();
...
void ButtergotchiConfigPins::validateRfScanRangeValue() {
    if (rfScanRange < 0 || rfScanRange > 3) rfScanRange = 3;
}

void ButtergotchiConfigPins::setRfidModule(RFIDModules value) {
    rfidModule = value;
    validateRfidModuleValue();
    saveFile();
}

void ButtergotchiConfigPins::validateRfidModuleValue() {
...
void ButtergotchiConfigPins::setiButtonPin(int value) {
    if (value < GPIO_NUM_MAX) {
        iButton = value;
        saveFile();
    } else log_e("iButton: Gpio pin not set, incompatible with this device\n");
}
void ButtergotchiConfigPins::setGpsBaudrate(int value) {
    gpsBaudrate = value;
    validateGpsBaudrateValue();
    saveFile();
}

void ButtergotchiConfigPins::validateGpsBaudrateValue() {
