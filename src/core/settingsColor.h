...
#define UI_COLOR_BUTTERGOTCHI_GOLD_PRI 0xFEC0
#define UI_COLOR_BUTTERGOTCHI_GOLD_SEC 0xCA60
#define UI_COLOR_BUTTERGOTCHI_GOLD_BG 0x0000
...
static constexpr ColorEntry UI_COLORS[] = {
    ...
    {"Buttergotchi Gold", UI_COLOR_BUTTERGOTCHI_GOLD_PRI, UI_COLOR_BUTTERGOTCHI_GOLD_SEC, UI_COLOR_BUTTERGOTCHI_GOLD_BG},
};
