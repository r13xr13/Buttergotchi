...
// ASCII equivalent
const String buttergotchi_moods[] = {
    "(v__v)", // 0 - sleeping
    "(=__=)", // 1 - awakening
    "(O__O)", // 2 - awake
...
const String buttergotchi_moods_desc[] = {
    "Zzzz...",                              // 0 - sleeping
    "...",                                  // 1 - awakening
...
const int number_of_moods = 23; // sizeof(buttergotchi_moods);
...
void setMood(uint8_t mood, String face, String phrase, bool broken) {
    ...
    if (face != "") {
        ...
        current_face = buttergotchi_moods[current_mood];
    }

    if (phrase != "") {
        current_phrase = phrase;
    } else {
        current_phrase = buttergotchi_moods_desc[current_mood];
    }
}
